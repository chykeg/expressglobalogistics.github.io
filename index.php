...
<title>Express Global Logistics ltd</title>
<meta name="keywords" content="Expressglobal, Express, Courier, Service" />
...
<div id="templatemo_header">
    <div id="site_title">
	<h2 align="left"><img src="images/logo.jpg" alt="Courier" width="70px" height="70px" />
	<span style="font:'Courier New', Courier, monospace">Express - Global Logistics</span></h2><span><h4 style="float: right;"><strong style="font-size: 14px;">Email</strong><br> customer@expressgloballogistics.com</h4></span>
</div>
</div>
<!-- Start WOWSlider.com BODY section -->
	<div id="wowslider-container1">
	<div class="ws_images"><ul>
<li><img src="data1/images/banner_1.jpg" alt="Global Express ®" title="SidEx Express ®" id="wows1_0"/></li>
<!-- <li><img src="data1/images/banner.png" alt="we know WE CAN DELIVER..." title="we know WE CAN DELIVER..." id="wows1_1"/></li> -->

<li><img src="data1/images/centrebanner_courier.jpg" alt="Customer Service" title="Customer Service" id="wows1_2"/></li>
</ul></div>
<div class="ws_bullets"><div>
<a href="#" title="Global Express ®"><img src="data1/tooltips/banner_1.jpg" alt="Global Express ®"/>1</a>

<a href="#" title="we know WE CAN DELIVER..."><img src="data1/tooltips/bann.jpg" alt="we know WE CAN DELIVER..."/>2</a>
    ...
    <div id="content"> 
		<div id="home" class="section">
			...
			<div id="home_about" class="box">
                ...
                <p><strong>Our Courier Services company aspires to become European most preferred end-to-end Logistics, Express &amp; Retail Services conglomerate with comprehensive global reach.</strong></p><p>&nbsp;&nbsp;</p>
            ...
            <div class="box home_box2 color3">
            	<div id="social_links">
                    <a href="https://www.facebook.com/Globalexpresslogistics" target="_blank"><img src="images/facebook.png" alt="Facebook" /></a>
					<a href="#"></a>
                    <a href="https://twitter.com/Globalexpresslogistics" target="_blank"><img src="images/twitter.png" alt="Twitter" /></a>
                    <a href="#"></a>
                    <a href="https://www.youtube.com/user/Globalexpresslogistics" target="_blank"><img src="images/youtube.png" alt="YouTube" /></a>
...
<form method="post" action="trackhome.php"> <table class="login_tab1">
  <tr>
    <td colspan="2" class='login_nam' valign='middle'>Track Shipment</td>
  </tr>
  <tr>
...
<div id="templatemo_footer">
	<div class="contact" style="text-align: left;">
						...
						<h4>Our Address</h4>
						<p>46 East Peachtree Street<br>McAllen, TX 78501.</p>
						<h4>Phone</h4>
						<p>+1(516)953-400</p>
						<h4>Turkey Address</h4>
						<p>Mesruity Street, Bilsar Binasl (Building) No.90-A 34430|<br>Sishane, Beyoglu, Istanbul 34430</p> 
						<h4>Phone</h4>
						<p>+1(516)953-400</p>
					</div>
						
					
    Copyright © 2018 <a href="expressgloballogistics.com">Exprss Global Logistics ltd</a>
</div>
